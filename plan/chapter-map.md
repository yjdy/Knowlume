...
| 11. Adapter 和外部软件边界 | `sources-and-adapters.md`、`architecture.md` | README 集成摘要 | Detailed complete |
| 12. 管理页面 | `interfaces.md` | README 能力摘要 | Detailed complete |
| 13. 安全、隐私和合规边界 | `security-publishing.md` | AGENTS 强制安全规则 | Detailed complete |
| 14. 阶段化实施计划 | `roadmap.md` | README 当前阶段 | Detailed complete |
| 15. 第一版明确不做 | `roadmap.md` | README 非目标摘要 | Detailed complete |
| 16. 第一版核心命令范围 | `roadmap.md`、`interfaces.md` | README 快速开始 | Detailed complete |
| 17. 验收清单 | `roadmap.md` 与可执行测试 | AGENTS 必跑验证 | Detailed complete |
| 18. 最终目标 | `architecture.md` | README 长期愿景 | Detailed complete |
...
- [ ] README 只保留项目入口和必要摘要。
- [ ] AGENTS 只保留长期有效的操作规则。
- [ ] 字段和枚举不在计划文档中复制定义，而是链接到 `schemas/`。
- [ ] 所有内部链接有效。
- [ ] Phase 0 契约测试通过。
