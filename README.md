...
且未创建 tag、上传包或创建 GitHub Release。Phase 4 只读 Web 的共享 catalog、安全 Markdown、
loopback 服务、Dashboard/Health、Source/Note 浏览、FTS/HTMX 搜索、本地与隔离 wheel 验收，
以及 Windows/macOS/Linux × Python 3.13/3.14 的
